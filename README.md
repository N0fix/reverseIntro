...
1. [Reverse, bases et introduction](#reverse-bases-et-introduction)
	...
	3. [Le processeur](#le-processeur)
	4. [Les appels de fonctions](#les-appels-de-fonctions)
...
> You can also find every system call number in 32bits in
...
set history save on # allows to find commands you already executed at last once with CTRL+R
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MjAyODAyNDMsMTgzMjk2MjgzMywtMT
